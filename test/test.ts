/*
 * @Date: 2020-5-7 18:54:39
 * @LastEditors: Huang canfeng
 * @LastEditTime: 2020-05-07 19:53:41
 * @Description:
 */
...
interface IRefundProgressList {
  ...
  contentList?: Array<IContentList>[]; // 操作内容列表
}
...
interface IGetRefundProgressResult {
  orderSn?: string; // 订单号
  refundSn?: string; // 售后单号
  refundProgressList?: Array<IRefundProgressList>[]; // 操作内容列表
  actionLayoutList?: Array<IActionLayoutList>[]; // 动作按钮布局列表
}

interface IGetRefundProgressResponseProps {
