...
import { IFrontWithdrawalRequestProps, IFrontWithdrawalResponseProps } from "./type";
//---------------------请求的url地址----------------------
const urls = {
...
export const postFrontWithdrawal: (IFrontWithdrawalRequestProps) => Promise<IFrontWithdrawalResponseProps> = () => post(urls.frontWithdrawal)
